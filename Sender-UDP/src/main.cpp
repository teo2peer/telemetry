...
void loop()
{
  ...
  String test = "bdijasnjidnasjondjasndjianojdnasojmdoasmdosoandonewu9nesonducweniuncuiwnc";
  char Buf[200];
  test.toCharArray(Buf, 200);
  uint8_t bufSend = (uint8_t)atoi(Buf);

  udp.write(bufSend); // the payload
